...
def saveMdlsByAcc(mdlsByAcc, ClusterFeats, site, path,pathShare):
    for id_CL in mdlsByAcc:
        #typ = id_CL==1 and "Best" or "Bad"
        name = site + "Model_" + (id_CL==1 and "Best" or "Bad")
        dump(mdlsByAcc[id_CL], path + name + ".Accmodel")
        dump(mdlsByAcc[id_CL], pathShare + name + ".Accmodel")
        #dump(ClusterFeats[id_CL], path + name + ".AccfeatRF")
        #dump(ClusterFeats[id_CL], pathShare + name + ".AccfeatRF")
